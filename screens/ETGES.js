...
const urlGetG = 'http://192.168.0.12:4000/SGS';
// const urlGetG = 'http://192.168.43.238:4000/SGS';
                    ...
                    <View style={[styles.content]}>
                        <View style={styles.content2}>
                            ...
                            <View style={styles.Title}>
                                <Text style={styles.textTitle}>  Eliminar Sub GES </Text>
                            </View>
                                ...
                                {this.state.lista.map(central => (
                                    <View style={styles.containerCardGris}>
                                        <View key={central.id}>
                                            ...
                                            <View style={styles.containerInfo}>
                                                <Text style={styles.textNegritas}>Tipo:   </Text>
                                                <Text style={{ fontSize: 16 }}>{central.tipo_ge}</Text>
                                            </View>
