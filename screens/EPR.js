...
const urlGetG = 'http://192.168.0.12:4000/PR';
// const urlGetG = 'http://192.168.43.238:4000/PR';
                    ...
                    <View style={[styles.content]}>
                        <View style={styles.content2}>
                            ...
                            <View style={styles.Title}>
                                <Text style={styles.textTitle}>  Eliminar Planta de Rectificadores </Text>
                            </View>
                                    ...
                                    <View style={styles.containerCardGris}>
                                        <View key={central.id}>
                                            ...
                                            <View style={styles.containerInfo}>
                                                ...
                                                <Text style={{ fontSize: 16 }}>{central.marca_pr}</Text>
                                            </View>
