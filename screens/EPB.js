...
const urlGetG = 'http://192.168.0.12:4000/PB';
// const urlGetG = 'http://192.168.43.238:4000/PB';
                    ...
                    <View style={[styles.content]}>
                        <View style={styles.content2}>
                            ...
                            <View style={styles.Title}>
                                <Text style={styles.textTitle}>  Eliminar Producción de Bancos</Text>
                            </View>
                                    ...
                                    {this.state.lista.map(central => (
                                        <View style={styles.containerCardGris}>
                                            <View key={central.id}>
                                                ...
                                                <View style={styles.containerInfo}>
                                                    <Text style={styles.textNegritas}>Nombre del Banco:   </Text>
                                                    <Text style={{ fontSize: 16 }}>{central.tipo_banco}</Text>
                                                </View>
