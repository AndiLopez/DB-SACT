                    ...
                    <View style={[styles.content]}>
                        <View style={styles.content2}>
                            ...
                            <View style={styles.Title}>
                                <Text style={styles.textTitle}>  Eliminar CA y Demanda Calculada</Text>
                            </View>
                                ...
                                {this.state.lista.map(central => (
                                    <View style={styles.containerCardGris}>
                                        <View key={central.id}>
                                            ...
                                            <View style={styles.containerInfo}>
                                                <Text style={styles.textNegritas}>Medición:   </Text>
                                                <Text style={{ fontSize: 16 }}>{central.medicion}</Text>
                                            </View>
